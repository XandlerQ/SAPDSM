...
public class PropertyGrid2<Property> {
    ...
    // PropertyGrid height
    private double defY;
    // Number of property areas along horizontal axis
    private int grCtX = 2;
    // Number of property areas along vertical axis
    private int grCtY = 1;
    // PropertyArea initial width
    private double sideX;
    // PropertyArea initial height
    private double sideY;
    // x coordinate of border between PropertyAreas
    private double intersection;
    // PropertyAreas in PropertyGrid
