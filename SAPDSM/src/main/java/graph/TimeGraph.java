...
public class TimeGraph {
    ...
    private ArrayList<Point2D> dots;
    ...
    TimeGraph() {
        ...
        this.integer = false;
        this.dots = new ArrayList<Point2D>();
    ...
    public TimeGraph(int dimX, int dimY, int capacity) {
        this(capacity);
        this.dimX = dimX;
        this.dimY = dimY;
    }
    ...
    ArrayList<Point2D> getDots() { return this.dots; }
    ...
    public void addValue(double val) {
        ...
        Point2D newDot = new Point2D(App.processingRef.millis() / 1000., val);
    ...
    void removeFirstDot() {
        Point2D firstDot = this.dots.get(0);
    ...
    void updateMinY() {
        ...
        for (Point2D dot : (Iterable<Point2D>) this.dots) {
            double y = dot.getY();
            if (y < newMinY) {
                newMinY = y;
            }
    ...
    Point2D calcAbsCoordinates(int index) {
        Point2D dot = this.dots.get(index);
        double absoluteX;
        if (index == 0) {
  ...
  */
    ...
    void renderDotsLine() {
        ...
        Point2D absoluteCoordinates;
        Point2D previousAbsoluteCoordinates = new Point2D();

        for(int dotIdx = 0; dotIdx < this.dots.size(); dotIdx++) {
            Point2D dot = this.dots.get(dotIdx);
    ...
    void renderLevelLine() {
        ...
        Point2D lastAbsoluteCoordinates = calcAbsCoordinates(this.dots.size() - 1);
